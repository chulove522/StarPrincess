...
namespace Game4
{
    public class FlyBubble : MonoBehaviour
    {
        ...
        public void Respawn(BubbleType type, Vector2 flyDir, Vector3 pos)
        {
            ...
            _renderer.sprite = Manager.Instance.BubbSprites[(int)type];
        ...
        private void OnCollisionEnter2D(Collision2D collision)
        {
            ...
            // REMARK 碰到墙壁角,不精确??
            var notContactTop = collision.contacts[0].point.y + GameConstant.BubbRadius * 2 < Manager.Instance.Anchors.TopEdge;
